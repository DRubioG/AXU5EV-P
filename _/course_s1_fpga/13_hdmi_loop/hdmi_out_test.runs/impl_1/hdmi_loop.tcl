...
namespace eval ::optrace {
  variable script "E:/XilinxPrj/AXU5EVB/2020/course_s1_fpga/13_hdmi_loop/hdmi_out_test.runs/impl_1/hdmi_loop.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/XilinxPrj/AXU5EVB/2020/course_s1_fpga/13_hdmi_loop/hdmi_out_test.runs/synth_1/hdmi_loop.dcp
...
OPTRACE "link_design" START { }
  link_design -top hdmi_loop -part xazu5ev-sfvc784-1-i
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force hdmi_loop_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file hdmi_loop_timing_summary_routed.rpt -pb hdmi_loop_timing_summary_routed.pb -rpx hdmi_loop_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file hdmi_loop_bus_skew_routed.rpt -pb hdmi_loop_bus_skew_routed.pb -rpx hdmi_loop_bus_skew_routed.rpx"
