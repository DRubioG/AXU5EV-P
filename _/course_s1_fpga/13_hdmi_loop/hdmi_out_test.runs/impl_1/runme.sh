...
HD_PWD='E:/XilinxPrj/AXU5EVB/2020/course_s1_fpga/13_hdmi_loop/hdmi_out_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_loop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_loop.tcl -notrace
