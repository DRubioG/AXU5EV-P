...
HD_PWD='E:/XilinxPrj/AXU5EVB/2020/course_s1_fpga/13_hdmi_loop/hdmi_out_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_loop.tcl
