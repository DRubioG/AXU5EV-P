...
HD_PWD='E:/XilinxPrj/AXU5EVB/2020/course_s2_standalone/22_vdma_hdmi_inout/vivado/vdma_hdmi_inout.runs/design_1_EEPROM_8b_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_EEPROM_8b_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_EEPROM_8b_0_0.tcl
