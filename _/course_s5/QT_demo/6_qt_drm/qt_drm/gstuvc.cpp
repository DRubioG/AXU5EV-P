...
void *task_gst_uvc(void *)
{
    ...
    const char *gst_comm = "v4l2src device=/dev/video1 ! video/x-raw,format=YUY2,width=1280,height=720 ! "
                           "kmssink sink-type=dp bus-id=fd4a0000.zynqmp-display fullscreen-overlay=false plane-id=38";
