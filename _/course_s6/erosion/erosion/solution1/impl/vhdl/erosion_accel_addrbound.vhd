...
entity erosion_accel_addrbound is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of erosion_accel_addrbound is 
...
begin
    mul_mul_15s_15s_15_4_1_U110 : component erosion_accel_mul_mul_15s_15s_15_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 15,
    ...
    grp_fu_43_ce_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, rows_empty_n, cols_empty_n)
    begin
    ...
    return_r_assign_proc : process(grp_fu_43_p2, return_r_preg, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
