set moduleName Loop_loop_height_proc79
set isTopModule 0
...
set C_modelName {Loop_loop_height_proc79}
...
set C_modelArgList {
	...
	{ img1_data int 24 regular {fifo 1 volatile }  }
	{ adj int 32 regular  }
	{ adj_out int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_axi_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "src_axi_V_keep_V", "interface" : "axis", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "src_axi_V_strb_V", "interface" : "axis", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "src_axi_V_user_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "src_axi_V_last_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "src_axi_V_id_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "src_axi_V_dest_V", "interface" : "axis", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "img1_data", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "adj", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "adj_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img1_data_din sc_out sc_lv 24 signal 7 } 
	{ img1_data_full_n sc_in sc_logic 1 signal 7 } 
	{ img1_data_write sc_out sc_logic 1 signal 7 } 
	{ adj sc_in sc_lv 32 signal 8 } 
	{ adj_ap_vld sc_in sc_logic 1 invld 8 } 
	{ adj_out_din sc_out sc_lv 32 signal 9 } 
	{ adj_out_full_n sc_in sc_logic 1 signal 9 } 
	{ adj_out_write sc_out sc_logic 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img1_data_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "img1_data", "role": "din" }} , 
 	{ "name": "img1_data_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img1_data", "role": "full_n" }} , 
 	{ "name": "img1_data_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img1_data", "role": "write" }} , 
 	...
 	{ "name": "adj_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "adj_out", "role": "din" }} , 
 	{ "name": "adj_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "adj_out", "role": "full_n" }} , 
 	{ "name": "adj_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "adj_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "img1_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2",
				"BlockSignal" : [
					{"Name" : "img1_data_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "adj", "Type" : "Vld", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "adj_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "adj_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3",
				"BlockSignal" : [
					{"Name" : "adj_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_user_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_last_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_id_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_axi_V_dest_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	src_axi_V_dest_V { axis {  { src_axi_TVALID in_vld 0 1 }  { src_axi_TREADY in_acc 1 1 }  { src_axi_TDEST in_data 0 1 } } }
	img1_data { ap_fifo {  { img1_data_din fifo_data 1 24 }  { img1_data_full_n fifo_status 0 1 }  { img1_data_write fifo_update 1 1 } } }
	adj { ap_vld {  { adj in_data 0 32 }  { adj_ap_vld in_vld 0 1 } } }
	adj_out { ap_fifo {  { adj_out_din fifo_data 1 32 }  { adj_out_full_n fifo_status 0 1 }  { adj_out_write fifo_update 1 1 } } }
}
