...
extern "C" void detectCorner(__cosim_sC__*, __cosim_sC__*, int);
extern "C" void apatb_detectCorner_hw(volatile void * __xlx_apatb_param_video_in, volatile void * __xlx_apatb_param_video_out, int __xlx_apatb_param_threshold) {
  ...
  // DUT call
  detectCorner(__xlx_video_in_input_buffer, __xlx_video_out_input_buffer, __xlx_apatb_param_threshold);
