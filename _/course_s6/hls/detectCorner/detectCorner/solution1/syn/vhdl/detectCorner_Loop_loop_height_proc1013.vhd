...
entity detectCorner_Loop_loop_height_proc1013 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of detectCorner_Loop_loop_height_proc1013 is 
...
attribute shreg_extract : string;
    ...
    signal ap_phi_mux_j_3_phi_fu_183_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_reg_pp0_iter0_j_3_reg_180 : STD_LOGIC_VECTOR (31 downto 0);
    signal j_2_fu_263_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((eol_2_reg_190 = ap_const_lv1_0) and (video_in_TVALID_int_regslice = ap_const_logic_0))) and (eol_2_reg_190 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
                eol_2_reg_190 <= video_in_TLAST_int_regslice;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((threshold_out_full_n = ap_const_logic_0) or (threshold_ap_vld = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                axi_data_V_reg_301 <= video_in_TDATA_int_regslice;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                axi_last_V_1_reg_306 <= video_in_TLAST_int_regslice;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, threshold_ap_vld, threshold_out_full_n, ap_CS_fsm_state6, ap_phi_mux_eol_2_phi_fu_193_p4, ap_enable_reg_pp0_iter0, icmp_ln122_fu_225_p2, icmp_ln119_fu_209_p2, ap_CS_fsm_state2, ap_block_pp0_stage0_subdone, eol_2_reg_190, video_in_TVALID_int_regslice)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((threshold_out_full_n = ap_const_logic_0) or (threshold_ap_vld = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
            ...
            when ap_ST_fsm_state6 => 
                if ((not(((eol_2_reg_190 = ap_const_lv1_0) and (video_in_TVALID_int_regslice = ap_const_logic_0))) and (eol_2_reg_190 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                elsif ((not(((eol_2_reg_190 = ap_const_lv1_0) and (video_in_TVALID_int_regslice = ap_const_logic_0))) and (ap_phi_mux_eol_2_phi_fu_193_p4 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(img_in_data_full_n, ap_enable_reg_pp0_iter0, icmp_ln122_fu_225_p2, ap_enable_reg_pp0_iter1, ap_predicate_op116_write_state4, video_in_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (img_in_data_full_n = ap_const_logic_0) and (ap_predicate_op116_write_state4 = ap_const_boolean_1)) or ((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (video_in_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(img_in_data_full_n, ap_enable_reg_pp0_iter0, icmp_ln122_fu_225_p2, ap_enable_reg_pp0_iter1, ap_predicate_op116_write_state4, video_in_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (img_in_data_full_n = ap_const_logic_0) and (ap_predicate_op116_write_state4 = ap_const_boolean_1)) or ((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (video_in_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(img_in_data_full_n, ap_enable_reg_pp0_iter0, icmp_ln122_fu_225_p2, ap_enable_reg_pp0_iter1, ap_predicate_op116_write_state4, video_in_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (img_in_data_full_n = ap_const_logic_0) and (ap_predicate_op116_write_state4 = ap_const_boolean_1)) or ((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (video_in_TVALID_int_regslice = ap_const_logic_0)));
    end process;


    ap_block_state1_assign_proc : process(real_start, ap_done_reg, threshold_ap_vld, threshold_out_full_n)
    begin
                ap_block_state1 <= ((threshold_out_full_n = ap_const_logic_0) or (threshold_ap_vld = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0));
    end process;


    ap_block_state3_pp0_stage0_iter0_assign_proc : process(icmp_ln122_fu_225_p2, video_in_TVALID_int_regslice)
    begin
                ap_block_state3_pp0_stage0_iter0 <= ((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (video_in_TVALID_int_regslice = ap_const_logic_0));
    end process;


    ap_block_state4_pp0_stage0_iter1_assign_proc : process(img_in_data_full_n, ap_predicate_op116_write_state4)
    begin
                ap_block_state4_pp0_stage0_iter1 <= ((img_in_data_full_n = ap_const_logic_0) and (ap_predicate_op116_write_state4 = ap_const_boolean_1));
    end process;


    ap_block_state6_assign_proc : process(eol_2_reg_190, video_in_TVALID_int_regslice)
    begin
                ap_block_state6 <= ((eol_2_reg_190 = ap_const_lv1_0) and (video_in_TVALID_int_regslice = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_j_3_phi_fu_183_p4_assign_proc : process(icmp_ln122_fu_225_p2, j_reg_148, or_ln131_fu_251_p2, or_ln134_fu_257_p2, ap_phi_reg_pp0_iter0_j_3_reg_180, j_2_fu_263_p2)
    begin
        if (((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (or_ln134_fu_257_p2 = ap_const_lv1_0) and (or_ln131_fu_251_p2 = ap_const_lv1_1))) then 
            ap_phi_mux_j_3_phi_fu_183_p4 <= j_2_fu_263_p2;
            ...
            ap_phi_mux_j_3_phi_fu_183_p4 <= j_reg_148;
        else 
            ap_phi_mux_j_3_phi_fu_183_p4 <= ap_phi_reg_pp0_iter0_j_3_reg_180;
        end if; 
    end process;
    ...
    ap_phi_reg_pp0_iter0_j_3_reg_180 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    ...
    img_in_data_blk_n_assign_proc : process(img_in_data_full_n, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln122_reg_297, or_ln134_reg_315, or_ln131_reg_311)
    begin
    ...
    img_in_data_din <= axi_data_V_reg_301;

    img_in_data_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op116_write_state4, ap_block_pp0_stage0_11001)
    begin
    ...
    j_2_fu_263_p2 <= std_logic_vector(unsigned(j_reg_148) + unsigned(ap_const_lv32_FFFFFFFF));
    j_4_fu_270_p2 <= std_logic_vector(unsigned(ap_phi_mux_j_3_phi_fu_183_p4) + unsigned(ap_const_lv32_1));
    or_ln131_fu_251_p2 <= (xor_ln131_fu_245_p2 or icmp_ln131_fu_239_p2);
    or_ln134_fu_257_p2 <= (video_in_TUSER_int_regslice or icmp_ln131_fu_239_p2);
    ...
    threshold_blk_n_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, threshold_ap_vld)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            threshold_blk_n <= threshold_ap_vld;
        else 
    ...
    threshold_out_write_assign_proc : process(real_start, ap_done_reg, ap_CS_fsm_state1, threshold_ap_vld, threshold_out_full_n)
    begin
        if ((not(((threshold_out_full_n = ap_const_logic_0) or (threshold_ap_vld = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1) or (real_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    video_in_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state6, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, icmp_ln122_fu_225_p2, eol_2_reg_190, video_in_TVALID_int_regslice)
    begin
    ...
    video_in_TREADY_int_regslice_assign_proc : process(ap_CS_fsm_state6, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, icmp_ln122_fu_225_p2, ap_block_pp0_stage0_11001, eol_2_reg_190, video_in_TVALID_int_regslice)
    begin
        if ((((icmp_ln122_fu_225_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or (not(((eol_2_reg_190 = ap_const_lv1_0) and (video_in_TVALID_int_regslice = ap_const_logic_0))) and (eol_2_reg_190 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6)))) then 
    ...
    xor_ln131_fu_245_p2 <= (video_in_TUSER_int_regslice xor ap_const_lv1_1);
end behav;
