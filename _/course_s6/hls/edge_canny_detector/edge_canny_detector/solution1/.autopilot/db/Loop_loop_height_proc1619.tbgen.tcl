set moduleName Loop_loop_height_proc1619
set isTopModule 0
...
set C_modelName {Loop_loop_height_proc1619}
...
set C_modelArgList {
	...
	{ rgb_img_src_data int 24 regular {fifo 1 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "src_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rgb_img_src_data", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ rgb_img_src_data_din sc_out sc_lv 24 signal 7 } 
	{ rgb_img_src_data_full_n sc_in sc_logic 1 signal 7 } 
	{ rgb_img_src_data_write sc_out sc_logic 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rgb_img_src_data_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rgb_img_src_data", "role": "din" }} , 
 	{ "name": "rgb_img_src_data_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rgb_img_src_data", "role": "full_n" }} , 
 	{ "name": "rgb_img_src_data_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rgb_img_src_data", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "rgb_img_src_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "1920",
				"BlockSignal" : [
			...
			{"Name" : "lowthreshold_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "7",
				"BlockSignal" : [
					{"Name" : "lowthreshold_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "highthreshold_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "7",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	rgb_img_src_data { ap_fifo {  { rgb_img_src_data_din fifo_data 1 24 }  { rgb_img_src_data_full_n fifo_status 0 1 }  { rgb_img_src_data_write fifo_update 1 1 } } }
