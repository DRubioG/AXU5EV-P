...
// clang-format off
    ...
    xf::cv::magnitude<1, XF_16SC1,XF_16SC1, IMG_MAX_ROWS, IMG_MAX_COLS, XF_NPPC1, 1920*3>(gradx1_mat, grady1_mat, magnitude_mat);
    ...
    xFSuppression3x3<XF_16SC1, XF_8UC1, XF_8UC1, IMG_MAX_ROWS, IMG_MAX_COLS, XF_16SP, XF_8UP, XF_8UP, XF_NPPC1, XF_16UW, XF_8UW, XF_8UW,
                        (IMG_MAX_COLS >> XF_BITSHIFT(XF_NPPC1)), 1920*3, 1920*3>(magnitude_mat, phase_mat, nms_mat, lowthreshold,
