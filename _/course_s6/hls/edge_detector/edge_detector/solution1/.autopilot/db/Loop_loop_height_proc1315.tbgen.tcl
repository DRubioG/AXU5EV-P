set moduleName Loop_loop_height_proc1315
set isTopModule 0
...
set C_modelName {Loop_loop_height_proc1315}
set C_modelType { void 0 }
set C_modelArgList {
	{ rgbSobel_data int 24 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rgbSobel_data", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rgbSobel_data_dout sc_in sc_lv 24 signal 0 } 
	{ rgbSobel_data_empty_n sc_in sc_logic 1 signal 0 } 
	{ rgbSobel_data_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rgbSobel_data_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "rgbSobel_data", "role": "dout" }} , 
 	{ "name": "rgbSobel_data_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rgbSobel_data", "role": "empty_n" }} , 
 	{ "name": "rgbSobel_data_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rgbSobel_data", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "rgbSobel_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "1920",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	rgbSobel_data { ap_fifo {  { rgbSobel_data_dout fifo_data 0 24 }  { rgbSobel_data_empty_n fifo_status 0 1 }  { rgbSobel_data_read fifo_update 1 1 } } }
