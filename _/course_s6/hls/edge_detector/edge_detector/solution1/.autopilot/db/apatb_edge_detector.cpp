...
// wrapc file define:
#define AUTOTB_TVIN_src_V_data_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_data_V.dat"
#define AUTOTB_TVOUT_src_V_data_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_data_V.dat"
#define AUTOTB_TVIN_src_V_keep_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_keep_V.dat"
#define AUTOTB_TVOUT_src_V_keep_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_keep_V.dat"
#define AUTOTB_TVIN_src_V_strb_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_strb_V.dat"
#define AUTOTB_TVOUT_src_V_strb_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_strb_V.dat"
#define AUTOTB_TVIN_src_V_user_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_user_V.dat"
#define AUTOTB_TVOUT_src_V_user_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_user_V.dat"
#define AUTOTB_TVIN_src_V_last_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_last_V.dat"
#define AUTOTB_TVOUT_src_V_last_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_last_V.dat"
#define AUTOTB_TVIN_src_V_id_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_id_V.dat"
#define AUTOTB_TVOUT_src_V_id_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_id_V.dat"
#define AUTOTB_TVIN_src_V_dest_V "../tv/cdatafile/c.edge_detector.autotvin_src_V_dest_V.dat"
#define AUTOTB_TVOUT_src_V_dest_V "../tv/cdatafile/c.edge_detector.autotvout_src_V_dest_V.dat"
...
// wrapc file define:
#define AUTOTB_TVIN_dst_V_data_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_data_V.dat"
#define AUTOTB_TVOUT_dst_V_data_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_data_V.dat"
#define AUTOTB_TVIN_dst_V_keep_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_keep_V.dat"
#define AUTOTB_TVOUT_dst_V_keep_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_keep_V.dat"
#define AUTOTB_TVIN_dst_V_strb_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_strb_V.dat"
#define AUTOTB_TVOUT_dst_V_strb_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_strb_V.dat"
#define AUTOTB_TVIN_dst_V_user_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_user_V.dat"
#define AUTOTB_TVOUT_dst_V_user_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_user_V.dat"
#define AUTOTB_TVIN_dst_V_last_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_last_V.dat"
#define AUTOTB_TVOUT_dst_V_last_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_last_V.dat"
#define AUTOTB_TVIN_dst_V_id_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_id_V.dat"
#define AUTOTB_TVOUT_dst_V_id_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_id_V.dat"
#define AUTOTB_TVIN_dst_V_dest_V "../tv/cdatafile/c.edge_detector.autotvin_dst_V_dest_V.dat"
#define AUTOTB_TVOUT_dst_V_dest_V "../tv/cdatafile/c.edge_detector.autotvout_dst_V_dest_V.dat"
...
// wrapc file define:
#define AUTOTB_TVIN_threshold "../tv/cdatafile/c.edge_detector.autotvin_threshold.dat"
#define AUTOTB_TVOUT_threshold "../tv/cdatafile/c.edge_detector.autotvout_threshold.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_src_V_data_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_data_V.dat"
#define AUTOTB_TVOUT_PC_src_V_keep_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_src_V_strb_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_src_V_user_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_user_V.dat"
#define AUTOTB_TVOUT_PC_src_V_last_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_last_V.dat"
#define AUTOTB_TVOUT_PC_src_V_id_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_id_V.dat"
#define AUTOTB_TVOUT_PC_src_V_dest_V "../tv/rtldatafile/rtl.edge_detector.autotvout_src_V_dest_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_dst_V_data_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_data_V.dat"
#define AUTOTB_TVOUT_PC_dst_V_keep_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_dst_V_strb_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_dst_V_user_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_user_V.dat"
#define AUTOTB_TVOUT_PC_dst_V_last_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_last_V.dat"
#define AUTOTB_TVOUT_PC_dst_V_id_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_id_V.dat"
#define AUTOTB_TVOUT_PC_dst_V_dest_V "../tv/rtldatafile/rtl.edge_detector.autotvout_dst_V_dest_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_threshold "../tv/rtldatafile/rtl.edge_detector.autotvout_threshold.dat"
...
extern "C" void edge_detector_hw_stub(volatile void *, volatile void *, __cosim_s1__);

extern "C" void apatb_edge_detector_hw(volatile void * __xlx_apatb_param_src, volatile void * __xlx_apatb_param_dst, __cosim_s1__ __xlx_apatb_param_threshold) {
...
unsigned xlx_stream_dst_size;

          std::vector<sc_bv<96> > dst_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_data_V_pc_buffer;
          int i = 0;
...
dst_V_data_V_pc_buffer_Copy=dst_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<96> > dst_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_keep_V_pc_buffer;
          int i = 0;
...
dst_V_keep_V_pc_buffer_Copy=dst_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<96> > dst_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_strb_V_pc_buffer;
          int i = 0;
...
dst_V_strb_V_pc_buffer_Copy=dst_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<96> > dst_V_user_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_user_V_pc_buffer;
          int i = 0;
...
dst_V_user_V_pc_buffer_Copy=dst_V_user_V_pc_buffer;
          ...
          std::vector<sc_bv<96> > dst_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_last_V_pc_buffer;
          int i = 0;
...
dst_V_last_V_pc_buffer_Copy=dst_V_last_V_pc_buffer;
          ...
          std::vector<sc_bv<96> > dst_V_id_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_id_V_pc_buffer;
          int i = 0;
...
dst_V_id_V_pc_buffer_Copy=dst_V_id_V_pc_buffer;
          ...
          std::vector<sc_bv<96> > dst_V_dest_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<96> > dst_V_dest_V_pc_buffer;
          int i = 0;
...
// print threshold Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)&__xlx_apatb_param_threshold);
...
edge_detector_hw_stub(__xlx_apatb_param_src, __xlx_apatb_param_dst, __xlx_apatb_param_threshold);
