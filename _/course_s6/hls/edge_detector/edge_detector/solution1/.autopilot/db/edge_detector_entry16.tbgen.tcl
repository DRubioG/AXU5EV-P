set moduleName edge_detector_entry16
set isTopModule 0
...
set C_modelName {edge_detector.entry16}
...
set portList { 
	...
	{ threshold_out_din sc_out sc_lv 8 signal 1 } 
	{ threshold_out_full_n sc_in sc_logic 1 signal 1 } 
	{ threshold_out_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "threshold_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2",
				"BlockSignal" : [
