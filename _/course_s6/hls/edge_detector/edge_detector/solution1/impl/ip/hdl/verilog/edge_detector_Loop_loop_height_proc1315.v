...
module edge_detector_Loop_loop_height_proc1315 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln190_reg_194 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (rgbSobel_data_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln190_reg_194 == 1'd0) & (rgbSobel_data_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln190_reg_194 == 1'd0) & (rgbSobel_data_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln190_reg_194 == 1'd0) & (rgbSobel_data_empty_n == 1'b0));
end
...
endmodule //edge_detector_Loop_loop_height_proc1315
