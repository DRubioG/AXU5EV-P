...
// clang-format off
    ...
    Xscale64 = xfUDivResize(xnew, (OUTWIDTH));
    Yscale64 = xfUDivResize(ynew, (OUTHEIGHT));
    ...
    int imgOutput_cols_align_npc = ((OUTWIDTH + (NPPC - 1)) >> XF_BITSHIFT(NPPC)) << XF_BITSHIFT(NPPC);
...
// clang-format off
    ...
    int loop_row_count = (OUTHEIGHT > imgInput.rows) ? OUTHEIGHT : imgInput.rows;
    int loop_col_count =
...
// clang-format off
            ...
            if ((output_rows_count <= OUTHEIGHT - 1) &&
