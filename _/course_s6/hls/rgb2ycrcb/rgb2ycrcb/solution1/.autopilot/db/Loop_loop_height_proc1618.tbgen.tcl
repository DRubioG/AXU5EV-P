set moduleName Loop_loop_height_proc1618
set isTopModule 0
...
set C_modelName {Loop_loop_height_proc1618}
...
set C_modelArgList {
	...
	{ img_src_data int 24 regular {fifo 1 volatile }  }
	{ en int 1 regular  }
	{ en_out int 1 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "src_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "src_V_keep_V", "interface" : "axis", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "src_V_strb_V", "interface" : "axis", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "img_src_data", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "en", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "en_out", "interface" : "fifo", "bitwidth" : 1, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_src_data_din sc_out sc_lv 24 signal 7 } 
	{ img_src_data_full_n sc_in sc_logic 1 signal 7 } 
	{ img_src_data_write sc_out sc_logic 1 signal 7 } 
	{ en sc_in sc_lv 1 signal 8 } 
	{ en_ap_vld sc_in sc_logic 1 invld 8 } 
	{ en_out_din sc_out sc_lv 1 signal 9 } 
	{ en_out_full_n sc_in sc_logic 1 signal 9 } 
	{ en_out_write sc_out sc_logic 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_src_data_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "img_src_data", "role": "din" }} , 
 	{ "name": "img_src_data_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_src_data", "role": "full_n" }} , 
 	{ "name": "img_src_data_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_src_data", "role": "write" }} , 
 	...
 	{ "name": "en_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "en_out", "role": "din" }} , 
 	{ "name": "en_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "en_out", "role": "full_n" }} , 
 	{ "name": "en_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "en_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			...
			{"Name" : "img_src_data", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "1920",
				"BlockSignal" : [
					{"Name" : "img_src_data_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "en", "Type" : "Vld", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "en_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "en_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3",
				"BlockSignal" : [
					{"Name" : "en_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_user_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_last_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_id_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_src_V_dest_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	img_src_data { ap_fifo {  { img_src_data_din fifo_data 1 24 }  { img_src_data_full_n fifo_status 0 1 }  { img_src_data_write fifo_update 1 1 } } }
	en { ap_vld {  { en in_data 0 1 }  { en_ap_vld in_vld 0 1 } } }
	en_out { ap_fifo {  { en_out_din fifo_data 1 1 }  { en_out_full_n fifo_status 0 1 }  { en_out_write fifo_update 1 1 } } }
}
