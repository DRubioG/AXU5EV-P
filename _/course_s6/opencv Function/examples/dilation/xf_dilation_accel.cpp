...
void dilation_accel(hls::stream<ap_axiu<24,1,1,1>>&img_inp,
                    hls::stream<ap_axiu<24,1,1,1>>&img_out)
{
// clang-format off
...
// clang-format off
    ...
    xf::cv::AXIvideo2xfMat<INPUT_PTR_WIDTH, TYPE, HEIGHT, WIDTH, NPC_T>(img_inp, in_mat);
    ...
    xf::cv::xfMat2AXIvideo<OUTPUT_PTR_WIDTH, TYPE, HEIGHT, WIDTH, NPC_T>(out_mat, img_out);
}
