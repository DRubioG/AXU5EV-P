...
#
# Generated by Vivado on Mon Oct 19 17:46:39 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/zynqUltraScale_vitis/course_s3_hls/vivado/01_led_control/led_control.cache/compile_simlib/activehdl"
  fi
