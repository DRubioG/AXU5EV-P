...
module rgb2gray_Loop_loop_height_proc4 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        video_in_TID,
        video_in_TDEST,
        img_rgb_src_data_din,
        img_rgb_src_data_full_n,
        img_rgb_src_data_write
);
...
output  [23:0] img_rgb_src_data_din;
input   img_rgb_src_data_full_n;
output   img_rgb_src_data_write;

reg ap_done;
reg ap_idle;
reg start_write;
reg img_rgb_src_data_write;
...
reg   [31:0] ap_phi_mux_j_2_phi_fu_151_p4;
wire   [31:0] ap_phi_reg_pp0_iter0_j_2_reg_148;
wire   [31:0] j_1_fu_231_p2;
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_reg_158 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (eol_2_reg_158 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_predicate_op47_write_state4 == 1'b1))) begin
        img_rgb_src_data_write = 1'b1;
    end else begin
        img_rgb_src_data_write = 1'b0;
    end
end
...
always @ (*) begin
    if ((((icmp_ln122_fu_193_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | (~((eol_2_reg_158 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (eol_2_reg_158 == 1'd0) & (1'b1 == ap_CS_fsm_state6)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if ((~((eol_2_reg_158 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (eol_2_reg_158 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else if ((~((eol_2_reg_158 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (ap_phi_mux_eol_2_phi_fu_161_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (img_rgb_src_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1)) | ((icmp_ln122_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (video_in_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (img_rgb_src_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1)) | ((icmp_ln122_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (video_in_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & (img_rgb_src_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1)) | ((icmp_ln122_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (video_in_TVALID_int_regslice == 1'b0)));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter0 = ((icmp_ln122_fu_193_p2 == 1'd1) & (video_in_TVALID_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((img_rgb_src_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1));
end

always @ (*) begin
    ap_block_state6 = ((eol_2_reg_158 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0));
end
...
assign ap_phi_reg_pp0_iter0_j_2_reg_148 = 'bx;
...
assign i_1_fu_183_p2 = (i_reg_93 + 11'd1);
...
assign img_rgb_src_data_din = axi_data_V_reg_269;

assign j_1_fu_231_p2 = ($signed(j_reg_116) + $signed(32'd4294967295));

assign j_3_fu_238_p2 = (ap_phi_mux_j_2_phi_fu_151_p4 + 32'd1);

assign or_ln131_fu_219_p2 = (xor_ln131_fu_213_p2 | icmp_ln131_fu_207_p2);

assign or_ln134_fu_225_p2 = (video_in_TUSER_int_regslice | icmp_ln131_fu_207_p2);

assign start_out = real_start;

assign video_in_TREADY = regslice_both_video_in_V_data_V_U_ack_in;

assign xor_ln131_fu_213_p2 = (video_in_TUSER_int_regslice ^ 1'd1);

endmodule //rgb2gray_Loop_loop_height_proc4
