...
proc create_root_design { parentCell } {
  ...
  # Create instance: overlaystream_0, and set properties
  set overlaystream_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:overlaystream:1.0 overlaystream_0 ]
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]
  ...
  connect_bd_intf_net -intf_net overlaystream_0_video_out [get_bd_intf_pins axis_subset_converter_1/S_AXIS] [get_bd_intf_pins overlaystream_0/video_out]
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins cpu_reg_v1_0_0/s00_axi_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins overlaystream_0/ap_rst_n] [get_bd_pins proc_sys_reset_150M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_gamma_lut_0/ap_rst_n]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma_0/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axis_subset_converter_0_m_axis_tdata [get_bd_pins axis_subset_converter_0/m_axis_tdata] [get_bd_pins overlaystream_0/video_in_TDATA]
  connect_bd_net -net axis_subset_converter_0_m_axis_tdest [get_bd_pins axis_subset_converter_0/m_axis_tdest] [get_bd_pins overlaystream_0/video_in_TDEST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tid [get_bd_pins axis_subset_converter_0/m_axis_tid] [get_bd_pins overlaystream_0/video_in_TID]
  connect_bd_net -net axis_subset_converter_0_m_axis_tkeep [get_bd_pins axis_subset_converter_0/m_axis_tkeep] [get_bd_pins overlaystream_0/video_in_TKEEP]
  connect_bd_net -net axis_subset_converter_0_m_axis_tlast [get_bd_pins axis_subset_converter_0/m_axis_tlast] [get_bd_pins overlaystream_0/video_in_TLAST]
  connect_bd_net -net axis_subset_converter_0_m_axis_tvalid [get_bd_pins axis_subset_converter_0/m_axis_tvalid] [get_bd_pins overlaystream_0/video_in_TVALID]
  connect_bd_net -net broadcast_0_m1_axi_video_tuser [get_bd_pins axis_subset_converter_0/m_axis_tuser] [get_bd_pins overlaystream_0/overly_alpha_ap_vld] [get_bd_pins overlaystream_0/overly_h_ap_vld] [get_bd_pins overlaystream_0/overly_w_ap_vld] [get_bd_pins overlaystream_0/overly_x_ap_vld] [get_bd_pins overlaystream_0/overly_y_ap_vld] [get_bd_pins overlaystream_0/video_in_TUSER]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out5 [get_bd_pins cpu_reg_v1_0_0/reg_out5] [get_bd_pins overlaystream_0/overly_alpha]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out6 [get_bd_pins cpu_reg_v1_0_0/reg_out6] [get_bd_pins overlaystream_0/overly_x]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out7 [get_bd_pins cpu_reg_v1_0_0/reg_out7] [get_bd_pins overlaystream_0/overly_y]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out8 [get_bd_pins cpu_reg_v1_0_0/reg_out8] [get_bd_pins overlaystream_0/overly_h]
  connect_bd_net -net cpu_reg_v1_0_0_reg_out9 [get_bd_pins cpu_reg_v1_0_0/reg_out9] [get_bd_pins overlaystream_0/overly_w]
  ...
  connect_bd_net -net overlaystream_0_video_in_TREADY [get_bd_pins axis_subset_converter_0/m_axis_tready] [get_bd_pins overlaystream_0/video_in_TREADY]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins cpu_reg_v1_0_0/s00_axi_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins overlaystream_0/ap_clk] [get_bd_pins proc_sys_reset_150M/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_gamma_lut_0/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
