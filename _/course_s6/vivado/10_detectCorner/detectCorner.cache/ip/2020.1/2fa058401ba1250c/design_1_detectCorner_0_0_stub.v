...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(overly_alpha_ap_vld, overly_x_ap_vld, 
  overly_y_ap_vld, overly_h_ap_vld, overly_w_ap_vld, threshold_ap_vld, video_in_TVALID, 
  ...
  video_out_TID, video_out_TDEST, overly_alpha, overly_x, overly_y, overly_h, overly_w, 
  threshold, ap_clk, ap_rst_n)
/* synthesis syn_black_box black_box_pad_pin="overly_alpha_ap_vld,overly_x_ap_vld,overly_y_ap_vld,overly_h_ap_vld,overly_w_ap_vld,threshold_ap_vld,video_in_TVALID,video_in_TREADY,video_in_TDATA[23:0],video_in_TKEEP[2:0],video_in_TSTRB[2:0],video_in_TUSER[0:0],video_in_TLAST[0:0],video_in_TID[0:0],video_in_TDEST[0:0],video_out_TVALID,video_out_TREADY,video_out_TDATA[23:0],video_out_TKEEP[2:0],video_out_TSTRB[2:0],video_out_TUSER[0:0],video_out_TLAST[0:0],video_out_TID[0:0],video_out_TDEST[0:0],overly_alpha[7:0],overly_x[31:0],overly_y[31:0],overly_h[31:0],overly_w[31:0],threshold[31:0],ap_clk,ap_rst_n" */;
