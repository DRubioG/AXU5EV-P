...
module detectCorner_Loop_loop_height_proc1013 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [31:0] ap_phi_mux_j_3_phi_fu_183_p4;
wire   [31:0] ap_phi_reg_pp0_iter0_j_3_reg_180;
wire   [31:0] j_2_fu_263_p2;
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_reg_190 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (eol_2_reg_190 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((threshold_out_full_n == 1'b0) | (threshold_ap_vld == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_reg_125 <= 11'd0;
    end
end
...
always @ (*) begin
    if ((~((threshold_out_full_n == 1'b0) | (threshold_ap_vld == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((((icmp_ln122_fu_225_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | (~((eol_2_reg_190 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (eol_2_reg_190 == 1'd0) & (1'b1 == ap_CS_fsm_state6)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state6 : begin
            if ((~((eol_2_reg_190 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (eol_2_reg_190 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else if ((~((eol_2_reg_190 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0)) & (ap_phi_mux_eol_2_phi_fu_193_p4 == 1'd1) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (img_in_data_full_n == 1'b0) & (ap_predicate_op116_write_state4 == 1'b1)) | ((icmp_ln122_fu_225_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (video_in_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (img_in_data_full_n == 1'b0) & (ap_predicate_op116_write_state4 == 1'b1)) | ((icmp_ln122_fu_225_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (video_in_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & (img_in_data_full_n == 1'b0) & (ap_predicate_op116_write_state4 == 1'b1)) | ((icmp_ln122_fu_225_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (video_in_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((threshold_out_full_n == 1'b0) | (threshold_ap_vld == 1'b0) | (ap_done_reg == 1'b1) | (real_start == 1'b0));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter0 = ((icmp_ln122_fu_225_p2 == 1'd1) & (video_in_TVALID_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((img_in_data_full_n == 1'b0) & (ap_predicate_op116_write_state4 == 1'b1));
end

always @ (*) begin
    ap_block_state6 = ((eol_2_reg_190 == 1'd0) & (video_in_TVALID_int_regslice == 1'b0));
end
...
assign ap_phi_reg_pp0_iter0_j_3_reg_180 = 'bx;
...
assign img_in_data_din = axi_data_V_reg_301;

assign j_2_fu_263_p2 = ($signed(j_reg_148) + $signed(32'd4294967295));

assign j_4_fu_270_p2 = (ap_phi_mux_j_3_phi_fu_183_p4 + 32'd1);

assign or_ln131_fu_251_p2 = (xor_ln131_fu_245_p2 | icmp_ln131_fu_239_p2);

assign or_ln134_fu_257_p2 = (video_in_TUSER_int_regslice | icmp_ln131_fu_239_p2);
...
assign xor_ln131_fu_245_p2 = (video_in_TUSER_int_regslice ^ 1'd1);

endmodule //detectCorner_Loop_loop_height_proc1013
