...
HD_PWD='F:/xilinx_project/AX7Z020/mipi_hdmi_7Z020/mipi_hdmi.runs/system_axi_dynclk_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_dynclk_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_dynclk_1_1.tcl
