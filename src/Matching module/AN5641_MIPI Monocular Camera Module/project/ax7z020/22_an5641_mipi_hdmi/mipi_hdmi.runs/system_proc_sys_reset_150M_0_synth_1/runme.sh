...
HD_PWD='F:/xilinx_project/AX7Z020/mipi_hdmi_7Z020/mipi_hdmi.runs/system_proc_sys_reset_150M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_proc_sys_reset_150M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_proc_sys_reset_150M_0.tcl
