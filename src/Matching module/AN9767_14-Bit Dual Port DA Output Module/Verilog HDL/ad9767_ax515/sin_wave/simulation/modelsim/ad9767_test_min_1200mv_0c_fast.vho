...
-- pragma translate_on
PORT MAP (
	i => \PLL_inst|altpll_component|auto_generated|wire_pll1_clk[1]~clkctrl_e_da1_clk_outclk\,
	devoe => ww_devoe,
	o => ww_da1_clk);
...
-- Equation(s):
-- \rom_addr[9]~25_combout\ = rom_addr(9) $ (!\rom_addr[8]~24\)
