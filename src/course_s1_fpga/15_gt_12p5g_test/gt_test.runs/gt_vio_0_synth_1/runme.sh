...
HD_PWD='E:/XilinxPrj/serdes/AXU5EV_P/gt_12p5g_test/gt_test.runs/gt_vio_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gt_vio_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gt_vio_0.tcl
