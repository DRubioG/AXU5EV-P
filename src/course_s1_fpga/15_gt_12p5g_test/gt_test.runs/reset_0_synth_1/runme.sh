...
HD_PWD='E:/XilinxPrj/serdes/AXU5EV_P/gt_12p5g_test/gt_test.runs/reset_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reset_0.tcl
