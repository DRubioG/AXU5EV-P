...
HD_PWD='E:/XilinxPrj/AXU5EVB/2020/course_s2_standalone/15_pl_net/vivado/pl_net.runs/design_1_axi_ethernet_0_refclk_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_ethernet_0_refclk_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_ethernet_0_refclk_0.tcl
