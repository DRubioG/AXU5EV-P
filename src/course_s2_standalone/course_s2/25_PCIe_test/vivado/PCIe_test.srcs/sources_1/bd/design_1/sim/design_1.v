...
module design_1
  ...
  assign diff_clock_rtl_1_1_CLK_N = pcie_ref_clk_n[0];
  assign diff_clock_rtl_1_1_CLK_P = pcie_ref_clk_p[0];
  assign pcie_mgt_txn[1:0] = xdma_0_pcie_mgt_txn;
  assign pcie_mgt_txp[1:0] = xdma_0_pcie_mgt_txp;
  assign reset_rtl_0_0_1 = pcie_rst_n;
  ...
  design_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp2_arready(1'b0),
        ...
        .saxigp2_arid({1'b0,1'b0,axi_interconnect_0_M00_AXI_ARID}),
        ...
        .saxigp2_awid({1'b0,1'b0,axi_interconnect_0_M00_AXI_AWID}),
