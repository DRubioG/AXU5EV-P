...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename p_kernel \
    op interface \
    ports { p_kernel_address0 { O 4 vector } p_kernel_ce0 { O 1 bit } p_kernel_we0 { O 1 bit } p_kernel_d0 { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { process_shape_dout { I 64 vector } process_shape_empty_n { I 1 bit } process_shape_read { O 1 bit } } \
} "
}
