set moduleName Mat2Axi_entry34
set isTopModule 0
...
set C_modelName {Mat2Axi.entry34}
...
set C_modelArgList {
	...
	{ rows_out int 15 regular {fifo 1}  }
	{ rows_out1 int 32 regular {fifo 1}  }
	{ cols_out int 15 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "dout", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rows_out", "interface" : "fifo", "bitwidth" : 15, "direction" : "WRITEONLY"} , 
 	{ "Name" : "rows_out1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "cols_out", "interface" : "fifo", "bitwidth" : 15, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ rows_out_din sc_out sc_lv 15 signal 4 } 
	...
	{ cols_out_din sc_out sc_lv 15 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rows_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "rows_out", "role": "din" }} , 
 	...
 	{ "name": "cols_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "cols_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	rows_out { ap_fifo {  { rows_out_din fifo_data 1 15 }  { rows_out_full_n fifo_status 0 1 }  { rows_out_write fifo_update 1 1 } } }
	rows_out1 { ap_fifo {  { rows_out1_din fifo_data 1 32 }  { rows_out1_full_n fifo_status 0 1 }  { rows_out1_write fifo_update 1 1 } } }
	cols_out { ap_fifo {  { cols_out_din fifo_data 1 15 }  { cols_out_full_n fifo_status 0 1 }  { cols_out_write fifo_update 1 1 } } }
