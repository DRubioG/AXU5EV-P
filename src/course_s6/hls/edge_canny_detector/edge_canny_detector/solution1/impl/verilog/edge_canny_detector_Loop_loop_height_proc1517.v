...
module edge_canny_detector_Loop_loop_height_proc1517 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_idle,
        ap_ready,
        rgb_img_dst_data_dout,
        rgb_img_dst_data_empty_n,
        rgb_img_dst_data_read,
        dst_TDATA,
        dst_TVALID,
        dst_TREADY,
        dst_TKEEP,
...
output   ap_idle;
output   ap_ready;
input  [23:0] rgb_img_dst_data_dout;
input   rgb_img_dst_data_empty_n;
output   rgb_img_dst_data_read;
...
reg ap_idle;
reg ap_ready;
reg rgb_img_dst_data_read;

reg    ap_done_reg;
(* fsm_encoding = "none" *) reg   [3:0] ap_CS_fsm;
wire    ap_CS_fsm_state1;
reg    rgb_img_dst_data_blk_n;
...
always @ (*) begin
    if (((icmp_ln190_reg_196 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rgb_img_dst_data_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((icmp_ln190_reg_196 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        rgb_img_dst_data_read = 1'b1;
    end else begin
        rgb_img_dst_data_read = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln190_reg_196 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (rgb_img_dst_data_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln190_reg_196 == 1'd0) & (rgb_img_dst_data_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln190_reg_196 == 1'd0) & (rgb_img_dst_data_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln190_reg_196 == 1'd0) & (rgb_img_dst_data_empty_n == 1'b0));
end
...
assign i_fu_163_p2 = (i_3_reg_120 + 11'd1);

assign icmp_ln188_fu_157_p2 = ((i_3_reg_120 == 11'd1080) ? 1'b1 : 1'b0);

assign icmp_ln190_fu_169_p2 = ((j_4_reg_131 == 11'd1920) ? 1'b1 : 1'b0);

assign j_fu_175_p2 = (j_4_reg_131 + 11'd1);

assign tmp_last_V_fu_181_p2 = ((j_4_reg_131 == 11'd1919) ? 1'b1 : 1'b0);

endmodule //edge_canny_detector_Loop_loop_height_proc1517
