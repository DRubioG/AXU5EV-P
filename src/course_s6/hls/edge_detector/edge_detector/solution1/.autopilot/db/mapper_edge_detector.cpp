...
extern "C" void edge_detector(__cosim_sC__*, __cosim_sC__*, __cosim_s1__);
extern "C" void apatb_edge_detector_hw(volatile void * __xlx_apatb_param_src, volatile void * __xlx_apatb_param_dst, __cosim_s1__ __xlx_apatb_param_threshold) {
  ...
  // DUT call
  edge_detector(__xlx_src_input_buffer, __xlx_dst_input_buffer, __xlx_apatb_param_threshold);
