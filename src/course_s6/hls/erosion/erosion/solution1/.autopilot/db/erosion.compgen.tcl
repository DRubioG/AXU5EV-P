...
set ID 55
set hasByteEnable 0
set MemName erosion_kernel_0_memcore
...
# FIFO definition:
set ID 56
set FifoName erosion_fifo_w24_d1920_A
set InstName rgb_src_data_U
...
# FIFO definition:
set ID 60
set FifoName erosion_start_for_rgb2YCrCb_1080_1920_U0
set InstName start_for_rgb2YCrCb_1080_1920_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 61
set FifoName erosion_start_for_YCrCb2rgb_1080_1920_U0
set InstName start_for_YCrCb2rgb_1080_1920_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 62
set FifoName erosion_start_for_Loop_loop_height_proc1618_U0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_TDEST { I 1 vector } src_TVALID { I 1 bit } src_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dst_TDEST { O 1 vector } dst_TVALID { O 1 bit } dst_TREADY { I 1 bit } } \
} "
} else {
