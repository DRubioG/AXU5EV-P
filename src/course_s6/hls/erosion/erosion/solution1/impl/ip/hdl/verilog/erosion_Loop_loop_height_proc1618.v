...
module erosion_Loop_loop_height_proc1618 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign icmp_ln190_fu_169_p2 = ((j_3_reg_131 == 11'd1920) ? 1'b1 : 1'b0);

assign j_fu_175_p2 = (j_3_reg_131 + 11'd1);

assign tmp_last_V_fu_181_p2 = ((j_3_reg_131 == 11'd1919) ? 1'b1 : 1'b0);

endmodule //erosion_Loop_loop_height_proc1618
