set moduleName Loop_loop_height_proc35
set isTopModule 0
...
set C_modelName {Loop_loop_height_proc35}
set C_modelType { void 0 }
set C_modelArgList {
	{ img_gray_dst_data int 24 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "img_gray_dst_data", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "video_out_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	{ "Name" : "video_out_V_keep_V", "interface" : "axis", "bitwidth" : 3, "direction" : "WRITEONLY"} , 
 	{ "Name" : "video_out_V_strb_V", "interface" : "axis", "bitwidth" : 3, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ img_gray_dst_data_dout sc_in sc_lv 24 signal 0 } 
	{ img_gray_dst_data_empty_n sc_in sc_logic 1 signal 0 } 
	{ img_gray_dst_data_read sc_out sc_logic 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_gray_dst_data_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "img_gray_dst_data", "role": "dout" }} , 
 	{ "name": "img_gray_dst_data_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_gray_dst_data", "role": "empty_n" }} , 
 	{ "name": "img_gray_dst_data_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_gray_dst_data", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "img_gray_dst_data", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "1920",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_user_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_last_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_id_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_video_out_V_dest_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	img_gray_dst_data { ap_fifo {  { img_gray_dst_data_dout fifo_data 0 24 }  { img_gray_dst_data_empty_n fifo_status 0 1 }  { img_gray_dst_data_read fifo_update 1 1 } } }
