...
module rgb2ycrcb_Loop_loop_height_proc1517 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((regslice_both_dst_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln188_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_condition_pp0_flush_enable)) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((regslice_both_dst_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln188_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((regslice_both_dst_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln188_fu_155_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter1_state4) & (ap_enable_reg_pp0_iter0 == 1'b0)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if (((regslice_both_dst_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln188_fu_155_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln190_reg_194 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (img_dst_data_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln190_reg_194 == 1'd0) & (img_dst_data_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state5_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln190_reg_194 == 1'd0) & (img_dst_data_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln190_reg_194 == 1'd0) & (dst_TREADY_int_regslice == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln190_reg_194 == 1'd0) & (img_dst_data_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln190_reg_194_pp0_iter1_reg == 1'd0) & (dst_TREADY_int_regslice == 1'b0));
end
...
endmodule //rgb2ycrcb_Loop_loop_height_proc1517
