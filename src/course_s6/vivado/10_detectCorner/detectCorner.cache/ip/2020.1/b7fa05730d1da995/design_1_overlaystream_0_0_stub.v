...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(overlay_alpha_ap_vld, video_in_TVALID, 
  ...
  video_out_TID, video_out_TDEST, video_coverlay_TVALID, video_coverlay_TREADY, 
  video_coverlay_TDATA, video_coverlay_TKEEP, video_coverlay_TSTRB, video_coverlay_TUSER, 
  video_coverlay_TLAST, video_coverlay_TID, video_coverlay_TDEST, overlay_alpha, ap_clk, 
  ap_rst_n)
/* synthesis syn_black_box black_box_pad_pin="overlay_alpha_ap_vld,video_in_TVALID,video_in_TREADY,video_in_TDATA[23:0],video_in_TKEEP[2:0],video_in_TSTRB[2:0],video_in_TUSER[0:0],video_in_TLAST[0:0],video_in_TID[0:0],video_in_TDEST[0:0],video_out_TVALID,video_out_TREADY,video_out_TDATA[23:0],video_out_TKEEP[2:0],video_out_TSTRB[2:0],video_out_TUSER[0:0],video_out_TLAST[0:0],video_out_TID[0:0],video_out_TDEST[0:0],video_coverlay_TVALID,video_coverlay_TREADY,video_coverlay_TDATA[23:0],video_coverlay_TKEEP[2:0],video_coverlay_TSTRB[2:0],video_coverlay_TUSER[0:0],video_coverlay_TLAST[0:0],video_coverlay_TID[0:0],video_coverlay_TDEST[0:0],overlay_alpha[31:0],ap_clk,ap_rst_n" */;
