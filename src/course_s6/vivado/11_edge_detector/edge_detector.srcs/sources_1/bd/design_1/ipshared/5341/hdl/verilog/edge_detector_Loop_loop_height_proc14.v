...
module edge_detector_Loop_loop_height_proc14 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (srcImg_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1)) | ((icmp_ln122_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter1 == 1'b1) & (srcImg_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1)) | ((icmp_ln122_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter1 == 1'b1) & (srcImg_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1)) | ((icmp_ln122_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (src_TVALID_int_regslice == 1'b0)));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((srcImg_data_full_n == 1'b0) & (ap_predicate_op47_write_state4 == 1'b1));
end
...
assign srcImg_data_din = axi_data_V_reg_269;
...
endmodule //edge_detector_Loop_loop_height_proc14
