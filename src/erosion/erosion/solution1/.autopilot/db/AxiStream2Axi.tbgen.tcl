...
set C_modelArgList {
	...
	{ addrbound_V_read int 15 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ldata1", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "addrbound_V_read", "interface" : "wire", "bitwidth" : 15, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ addrbound_V_read sc_in sc_lv 15 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "addrbound_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "addrbound_V_read", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "16392"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "16392"}
]}
...
set Spec2ImplPortList { 
	ldata1 { ap_fifo {  { ldata1_dout fifo_data 0 8 }  { ldata1_empty_n fifo_status 0 1 }  { ldata1_read fifo_update 1 1 } } }
	...
	addrbound_V_read { ap_none {  { addrbound_V_read in_data 0 15 } } }
}
