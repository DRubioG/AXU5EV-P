set moduleName Loop_VITIS_LOOP_35_1_proc
set isTopModule 0
...
set C_modelName {Loop_VITIS_LOOP_35_1_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ process_shape int 64 regular {fifo 0}  }
	{ gmem1 int 8 regular {axi_master 0}  }
	{ p_kernel int 8 regular {array 9 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "process_shape", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "p_kernel", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ process_shape_dout sc_in sc_lv 64 signal 0 } 
	{ process_shape_empty_n sc_in sc_logic 1 signal 0 } 
	{ process_shape_read sc_out sc_logic 1 signal 0 } 
	...
	{ p_kernel_address0 sc_out sc_lv 4 signal 2 } 
	{ p_kernel_ce0 sc_out sc_logic 1 signal 2 } 
	{ p_kernel_we0 sc_out sc_logic 1 signal 2 } 
	{ p_kernel_d0 sc_out sc_lv 8 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "process_shape_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "process_shape", "role": "dout" }} , 
 	{ "name": "process_shape_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "process_shape", "role": "empty_n" }} , 
 	{ "name": "process_shape_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "process_shape", "role": "read" }} , 
 	...
 	{ "name": "p_kernel_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_kernel", "role": "we0" }} , 
 	{ "name": "p_kernel_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_kernel", "role": "d0" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "Loop_VITIS_LOOP_35_1_proc",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			{"Name" : "process_shape", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2",
				"BlockSignal" : [
					{"Name" : "process_shape_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "gmem1_blk_n_AR", "Type" : "RtlSignal"},
					{"Name" : "gmem1_blk_n_R", "Type" : "RtlSignal"}]},
			{"Name" : "p_kernel", "Type" : "Memory", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0"}]}]}
...
set ArgLastReadFirstWriteLatency {
	Loop_VITIS_LOOP_35_1_proc {
		...
		p_kernel {Type O LastRead -1 FirstWrite 10}}}
...
set Spec2ImplPortList { 
	process_shape { ap_fifo {  { process_shape_dout fifo_data 0 64 }  { process_shape_empty_n fifo_status 0 1 }  { process_shape_read fifo_update 1 1 } } }
	...
	p_kernel { ap_memory {  { p_kernel_address0 mem_address 1 4 }  { p_kernel_ce0 mem_ce 1 1 }  { p_kernel_we0 mem_we 1 1 }  { p_kernel_d0 mem_din 1 8 } } }
}
