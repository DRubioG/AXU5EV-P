...
entity erosion_accel_Mat2Axi is
port (
...
architecture behav of erosion_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    signal Mat2Axi_entry34_U0_ap_start : STD_LOGIC;
    signal Mat2Axi_entry34_U0_ap_done : STD_LOGIC;
    signal Mat2Axi_entry34_U0_ap_continue : STD_LOGIC;
    signal Mat2Axi_entry34_U0_ap_idle : STD_LOGIC;
    signal Mat2Axi_entry34_U0_ap_ready : STD_LOGIC;
    signal Mat2Axi_entry34_U0_start_out : STD_LOGIC;
    signal Mat2Axi_entry34_U0_start_write : STD_LOGIC;
    signal Mat2Axi_entry34_U0_dout_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal Mat2Axi_entry34_U0_dout_out_write : STD_LOGIC;
    signal Mat2Axi_entry34_U0_rows_out_din : STD_LOGIC_VECTOR (14 downto 0);
    signal Mat2Axi_entry34_U0_rows_out_write : STD_LOGIC;
    signal Mat2Axi_entry34_U0_rows_out1_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Mat2Axi_entry34_U0_rows_out1_write : STD_LOGIC;
    signal Mat2Axi_entry34_U0_cols_out_din : STD_LOGIC_VECTOR (14 downto 0);
    signal Mat2Axi_entry34_U0_cols_out_write : STD_LOGIC;
    signal Mat2Axi_entry34_U0_cols_out2_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Mat2Axi_entry34_U0_cols_out2_write : STD_LOGIC;
    ...
    signal addrbound_U0_return_r : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal Mat2Axi_Block_split13_proc_U0_ap_return : STD_LOGIC_VECTOR (14 downto 0);
    signal ap_channel_done_axibound_V : STD_LOGIC;
    signal axibound_V_full_n : STD_LOGIC;
    signal Mat2AxiStream_U0_imgOutput_418_read : STD_LOGIC;
    ...
    signal rows_c_dout : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal cols_c_dout : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal ap_sync_reg_Mat2Axi_entry34_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Mat2Axi_entry34_U0_ap_ready : STD_LOGIC;
    signal Mat2Axi_entry34_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component erosion_accel_Mat2Axi_entry34 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        rows_out_din : OUT STD_LOGIC_VECTOR (14 downto 0);
        ...
        cols_out_din : OUT STD_LOGIC_VECTOR (14 downto 0);
    ...
    component erosion_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        rows_dout : IN STD_LOGIC_VECTOR (14 downto 0);
        rows_empty_n : IN STD_LOGIC;
        rows_read : OUT STD_LOGIC;
        cols_dout : IN STD_LOGIC_VECTOR (14 downto 0);
        cols_empty_n : IN STD_LOGIC;
        cols_read : OUT STD_LOGIC );
    end component;


    component erosion_accel_Mat2Axi_Block_split13_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_V_1 : IN STD_LOGIC_VECTOR (14 downto 0);
        ap_return : OUT STD_LOGIC_VECTOR (14 downto 0) );
    end component;


    component erosion_accel_Mat2AxiStream IS
    port (
        imgOutput_418_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        imgOutput_418_empty_n : IN STD_LOGIC;
        imgOutput_418_read : OUT STD_LOGIC;
    ...
    component erosion_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component erosion_accel_fifo_w64_d4_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component erosion_accel_fifo_w15_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component erosion_accel_fifo_w32_d2_S_x0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component erosion_accel_fifo_w8_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component erosion_accel_start_for_addrbound_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Mat2Axi_entry34_U0 : component erosion_accel_Mat2Axi_entry34
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => Mat2Axi_entry34_U0_ap_start,
        start_full_n => start_for_addrbound_U0_full_n,
        ap_done => Mat2Axi_entry34_U0_ap_done,
        ap_continue => Mat2Axi_entry34_U0_ap_continue,
        ap_idle => Mat2Axi_entry34_U0_ap_idle,
        ap_ready => Mat2Axi_entry34_U0_ap_ready,
        start_out => Mat2Axi_entry34_U0_start_out,
        start_write => Mat2Axi_entry34_U0_start_write,
        dout => dout,
        rows => rows,
        cols => cols,
        dout_out_din => Mat2Axi_entry34_U0_dout_out_din,
        dout_out_full_n => dout_c_full_n,
        dout_out_write => Mat2Axi_entry34_U0_dout_out_write,
        rows_out_din => Mat2Axi_entry34_U0_rows_out_din,
        rows_out_full_n => rows_c_full_n,
        rows_out_write => Mat2Axi_entry34_U0_rows_out_write,
        rows_out1_din => Mat2Axi_entry34_U0_rows_out1_din,
        rows_out1_full_n => rows_c10_full_n,
        rows_out1_write => Mat2Axi_entry34_U0_rows_out1_write,
        cols_out_din => Mat2Axi_entry34_U0_cols_out_din,
        cols_out_full_n => cols_c_full_n,
        cols_out_write => Mat2Axi_entry34_U0_cols_out_write,
        cols_out2_din => Mat2Axi_entry34_U0_cols_out2_din,
        cols_out2_full_n => cols_c11_full_n,
        cols_out2_write => Mat2Axi_entry34_U0_cols_out2_write);

    addrbound_U0 : component erosion_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_split13_proc_U0 : component erosion_accel_Mat2Axi_Block_split13_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component erosion_accel_Mat2AxiStream
    port map (
        imgOutput_418_dout => imgOutput_418_dout,
        imgOutput_418_empty_n => imgOutput_418_empty_n,
        imgOutput_418_read => Mat2AxiStream_U0_imgOutput_418_read,
    ...
    AxiStream2Axi_U0 : component erosion_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component erosion_accel_fifo_w64_d4_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mat2Axi_entry34_U0_dout_out_din,
        if_full_n => dout_c_full_n,
        if_write => Mat2Axi_entry34_U0_dout_out_write,
        if_dout => dout_c_dout,
        if_empty_n => dout_c_empty_n,
        if_read => AxiStream2Axi_U0_dout_read);

    rows_c_U : component erosion_accel_fifo_w15_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mat2Axi_entry34_U0_rows_out_din,
        if_full_n => rows_c_full_n,
        if_write => Mat2Axi_entry34_U0_rows_out_write,
        if_dout => rows_c_dout,
        if_empty_n => rows_c_empty_n,
        if_read => addrbound_U0_rows_read);

    rows_c10_U : component erosion_accel_fifo_w32_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mat2Axi_entry34_U0_rows_out1_din,
        if_full_n => rows_c10_full_n,
        if_write => Mat2Axi_entry34_U0_rows_out1_write,
        if_dout => rows_c10_dout,
        if_empty_n => rows_c10_empty_n,
        if_read => Mat2AxiStream_U0_rows_read);

    cols_c_U : component erosion_accel_fifo_w15_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mat2Axi_entry34_U0_cols_out_din,
        if_full_n => cols_c_full_n,
        if_write => Mat2Axi_entry34_U0_cols_out_write,
        if_dout => cols_c_dout,
        if_empty_n => cols_c_empty_n,
        if_read => addrbound_U0_cols_read);

    cols_c11_U : component erosion_accel_fifo_w32_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Mat2Axi_entry34_U0_cols_out2_din,
        if_full_n => cols_c11_full_n,
        if_write => Mat2Axi_entry34_U0_cols_out2_write,
        if_dout => cols_c11_dout,
        if_empty_n => cols_c11_empty_n,
        if_read => Mat2AxiStream_U0_cols_read);

    p_channel_U : component erosion_accel_fifo_w15_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component erosion_accel_fifo_w15_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component erosion_accel_fifo_w8_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_addrbound_U0_U : component erosion_accel_start_for_addrbound_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_write => Mat2Axi_entry34_U0_start_write,
    ...
    ap_sync_reg_Mat2Axi_entry34_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_Mat2Axi_entry34_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Mat2Axi_entry34_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_Mat2Axi_entry34_U0_ap_ready <= ap_sync_Mat2Axi_entry34_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    Mat2Axi_entry34_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Mat2Axi_entry34_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Mat2Axi_entry34_U0_ap_ready_count <= std_logic_vector(unsigned(Mat2Axi_entry34_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Mat2Axi_entry34_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Mat2Axi_entry34_U0_ap_ready_count <= std_logic_vector(unsigned(Mat2Axi_entry34_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Mat2Axi_entry34_U0_ap_continue <= ap_const_logic_1;
    Mat2Axi_entry34_U0_ap_start <= ((ap_sync_reg_Mat2Axi_entry34_U0_ap_ready xor ap_const_logic_1) and ap_start);
    ...
    ap_done <= AxiStream2Axi_U0_ap_done;
    ap_idle <= ((axibound_V_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and addrbound_U0_ap_idle and Mat2Axi_entry34_U0_ap_idle and Mat2Axi_Block_split13_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
    ap_ready <= ap_sync_ready;
    ap_sync_Mat2AxiStream_U0_ap_ready <= (ap_sync_reg_Mat2AxiStream_U0_ap_ready or Mat2AxiStream_U0_ap_ready);
    ap_sync_Mat2Axi_entry34_U0_ap_ready <= (ap_sync_reg_Mat2Axi_entry34_U0_ap_ready or Mat2Axi_entry34_U0_ap_ready);
    ap_sync_continue <= ap_continue;
    ap_sync_done <= AxiStream2Axi_U0_ap_done;
    ap_sync_ready <= (ap_sync_Mat2Axi_entry34_U0_ap_ready and ap_sync_Mat2AxiStream_U0_ap_ready);
    imgOutput_418_read <= Mat2AxiStream_U0_imgOutput_418_read;
