...
entity erosion_accel_addrbound18 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of erosion_accel_addrbound18 is 
...
attribute shreg_extract : string;
    ...
    signal grp_fu_73_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal return_r_preg : STD_LOGIC_VECTOR (14 downto 0) := "000000000000000";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal grp_fu_73_p0 : STD_LOGIC_VECTOR (14 downto 0);
    signal grp_fu_73_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal grp_fu_73_ce : STD_LOGIC;
    signal ap_NS_fsm : STD_LOGIC_VECTOR (3 downto 0);

    component erosion_accel_mul_mul_15s_15s_15_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mul_mul_15s_15s_15_4_1_U33 : component erosion_accel_mul_mul_15s_15s_15_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 15,
    ...
    grp_fu_73_ce_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, rows_empty_n, cols_empty_n, rows_out_full_n, cols_out_full_n)
    begin
    ...
    grp_fu_73_p0 <= cols_dout(15 - 1 downto 0);
    grp_fu_73_p1 <= rows_dout(15 - 1 downto 0);

    return_r_assign_proc : process(grp_fu_73_p2, return_r_preg, ap_CS_fsm_state4)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
