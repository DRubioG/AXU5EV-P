...
module erosion_accel_addrbound18 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    cols_out_blk_n;
reg    ap_block_state1;
wire  signed [14:0] grp_fu_73_p2;
reg   [14:0] return_r_preg;
wire    ap_CS_fsm_state4;
wire  signed [14:0] grp_fu_73_p0;
...
erosion_accel_mul_mul_15s_15s_15_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 15 ),
    .din1_WIDTH( 15 ),
    .dout_WIDTH( 15 ))
mul_mul_15s_15s_15_4_1_U33(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_73_p0),
    .din1(grp_fu_73_p1),
...
assign grp_fu_73_p0 = cols_dout[14:0];

assign grp_fu_73_p1 = rows_dout[14:0];

assign rows_out_din = rows_dout;

endmodule //erosion_accel_addrbound18
