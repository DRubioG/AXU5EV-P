...
--               g:/mpsoc_vivado/axu5ev_vcu_only/axu5ev_vcu_only.srcs/sources_1/bd/zcu104_vcu/ip/zcu104_vcu_vcu_clk_wiz0_0/zcu104_vcu_vcu_clk_wiz0_0_sim_netlist.vhdl
...
entity zcu104_vcu_vcu_clk_wiz0_0_zcu104_vcu_vcu_clk_wiz0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of zcu104_vcu_vcu_clk_wiz0_0_zcu104_vcu_vcu_clk_wiz0_0_clk_wiz : entity is "zcu104_vcu_vcu_clk_wiz0_0_clk_wiz";
end zcu104_vcu_vcu_clk_wiz0_0_zcu104_vcu_vcu_clk_wiz0_0_clk_wiz;

architecture STRUCTURE of zcu104_vcu_vcu_clk_wiz0_0_zcu104_vcu_vcu_clk_wiz0_0_clk_wiz is
  signal clk_in1_zcu104_vcu_vcu_clk_wiz0_0 : STD_LOGIC;
  signal clk_out1_zcu104_vcu_vcu_clk_wiz0_0 : STD_LOGIC;
  signal clk_out2_zcu104_vcu_vcu_clk_wiz0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_zcu104_vcu_vcu_clk_wiz0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_zcu104_vcu_vcu_clk_wiz0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_zcu104_vcu_vcu_clk_wiz0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 66.625000,
      ...
      CLKIN1 => clk_in1_zcu104_vcu_vcu_clk_wiz0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_zcu104_vcu_vcu_clk_wiz0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_zcu104_vcu_vcu_clk_wiz0_0,
...
entity zcu104_vcu_vcu_clk_wiz0_0 is
  ...
  attribute NotValidForBitStream of zcu104_vcu_vcu_clk_wiz0_0 : entity is true;
end zcu104_vcu_vcu_clk_wiz0_0;

architecture STRUCTURE of zcu104_vcu_vcu_clk_wiz0_0 is
begin
inst: entity work.zcu104_vcu_vcu_clk_wiz0_0_zcu104_vcu_vcu_clk_wiz0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
